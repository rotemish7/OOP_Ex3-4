 ...
 */
	...
	/**
	 * 
	 * @return a string represents the graph in kml format
	 */
	public String graph_to_kml(); 
	
	/**
	 * 
	 * @param src represents the src node of the edge
	 * @param dest represents the dst node of the edge
	 * @return a string of the edge cordinates
	 */
